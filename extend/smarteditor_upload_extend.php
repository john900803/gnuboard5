...
define('SMARTEDITOR_UPLOAD_MAX_WIDTH', 3840);  // 스마트에디터 업로드 이미지 리사이즈 제한 width
define('SMARTEDITOR_UPLOAD_MAX_HEIGHT', 2160);  // 스마트에디터 업로드 이미지 리사이즈 제한 height
define('SMARTEDITOR_UPLOAD_SIZE_LIMIT', 50);  // 스마트에디터 업로드 사이즈 제한 ( 기본 20MB )
